...
{
    internal class CompareCommandCompiler: CommandCompiler
    {
        public override CommandType CommandType => CommandType.CMP;
        ...
        {
            return new CompareCommand(operands[0].value, operands[1].value);
        }
    }
}
